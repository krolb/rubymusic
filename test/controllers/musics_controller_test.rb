...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { artist: @music.artist, song: @music.song, title: @music.title, user_id: @music.user_id }
    end
  ...
  test "should update music" do
    patch :update, id: @music, music: { artist: @music.artist, song: @music.song, title: @music.title, user_id: @music.user_id }
    assert_redirected_to music_path(assigns(:music))
  end
